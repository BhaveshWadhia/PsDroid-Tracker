...
public class AddUsersActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addUser_toolbar = findViewById(R.id.addContacts_toolbar);  //Set toolbar for the application
